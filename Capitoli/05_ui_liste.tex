...
\begin{enumerate}
    ...
    \item Se \texttt{convertView != null}, \textbf{non facciamo un nuovo "inflate" del layout XML}, ma ci limitiamo a riutilizzare la riga cambiando i testi/immagini al suo interno.
\end{enumerate}
