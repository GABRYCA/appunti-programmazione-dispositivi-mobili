...
\begin{enumerate}
    ...
    \item Nel metodo \texttt{onStartCommand()} si lancia \texttt{startForeground(id, notification)} e si ritorna \texttt{START\_STICKY} (dice al sistema di riavviare il Service se ucciso per mancanza di memoria).
\end{enumerate}
