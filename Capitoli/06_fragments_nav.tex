...
\begin{center}
    \begin{tikzpicture}[
        ...
        \node[state, fill=orange!20, right=2cm of start] (pause) {\textbf{onPause()} / \textbf{onStop()}\\Non visibile};
        ...
        \draw[arrow, dashed, blue] (destroyview.west) -- ++(-1,0) |- node[pos=0.3, fill=white, align=center] {Ritorno dal\\Backstack} (createview.east);
    \end{tikzpicture}
\end{center}
