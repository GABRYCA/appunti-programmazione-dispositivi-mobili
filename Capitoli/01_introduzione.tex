...
\subsection{Gradle}
Il sistema di build utilizzato da Android Studio è \textbf{Gradle}. È un sistema open-source per l'automazione della build che utilizza un DSL (Domain-Specific Language) basato su Groovy o Kotlin (KTS), sostituendo i vecchi file XML (usati da Ant o Maven). 
\newline\noindent\textbf{Cosa fa Gradle in Android?}
\begin{itemize}
    \item Compila il codice sorgente e le risorse.
    \item Gestisce le dipendenze esterne.
    \item Pacchettizza il tutto in un file \textbf{APK}.
    \item Firma (Sign) l'applicazione per la distribuzione.
\end{itemize}
