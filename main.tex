...
\begin{document}
    ...
    \input{capitoli/02_kotlin}
    \input{capitoli/03_risorse_ui}
    \input{capitoli/04_activity_intents}
    \input{Capitoli/05_ui_liste}
    \input{Capitoli/06_fragments_nav}
    \input{Capitoli/07_compose}
    \input{Capitoli/08_background_services}
    \input{Capitoli/09_persistenza}
